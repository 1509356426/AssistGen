...
class SendRequest:
    ...
    def get(self, url, data, header):
        ...
        try:
            if data is None:
                response = requests.get(url, headers=header, cookies=self.cookie, verify=False, proxies={"http": None, "https": None})
            else:
                response = requests.get(url, data, headers=header, cookies=self.cookie, verify=False, proxies={"http": None, "https": None})
    ...
    def post(self, url, data, header):
        ...
        try:
            if data is None:
                response = requests.post(url, header, cookies=self.cookie, verify=False, proxies={"http": None, "https": None})
            else:
                response = requests.post(url, data, headers=header, cookies=self.cookie, verify=False, proxies={"http": None, "https": None})
        except requests.RequestException as e:
            logs.error(e)
            return None
        except Exception as e:
